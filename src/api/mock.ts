  ...
  generationPlans: [
    {
      ...
      emissionLimit: 5000,
      schedules: [
        { unitId: 'U001', status: 'running', hour0: 450, hour1: 440, hour2: 420, hour3: 400, hour4: 400, hour5: 420, hour6: 450, hour7: 480, hour8: 510, hour9: 530, hour10: 540, hour11: 550, hour12: 540, hour13: 530, hour14: 520, hour15: 520, hour16: 530, hour17: 540, hour18: 550, hour19: 560, hour20: 550, hour21: 530, hour22: 500, hour23: 470 },
        { unitId: 'U002', status: 'running', hour0: 480, hour1: 470, hour2: 450, hour3: 430, hour4: 430, hour5: 450, hour6: 480, hour7: 510, hour8: 540, hour9: 560, hour10: 570, hour11: 580, hour12: 570, hour13: 560, hour14: 550, hour15: 550, hour16: 560, hour17: 570, hour18: 580, hour19: 590, hour20: 580, hour21: 560, hour22: 530, hour23: 500 },
        { unitId: 'U004', status: 'running', hour0: 420, hour1: 410, hour2: 390, hour3: 370, hour4: 370, hour5: 390, hour6: 420, hour7: 450, hour8: 480, hour9: 500, hour10: 510, hour11: 520, hour12: 510, hour13: 500, hour14: 490, hour15: 490, hour16: 500, hour17: 510, hour18: 520, hour19: 530, hour20: 520, hour21: 500, hour22: 470, hour23: 440 },
        { unitId: 'U005', status: 'running', hour0: 600, hour1: 580, hour2: 550, hour3: 520, hour4: 520, hour5: 550, hour6: 600, hour7: 640, hour8: 670, hour9: 690, hour10: 700, hour11: 700, hour12: 690, hour13: 680, hour14: 670, hour15: 670, hour16: 680, hour17: 690, hour18: 700, hour19: 700, hour20: 690, hour21: 670, hour22: 640, hour23: 610 },
        { unitId: 'U006', status: 'running', hour0: 620, hour1: 600, hour2: 570, hour3: 540, hour4: 540, hour5: 570, hour6: 620, hour7: 660, hour8: 690, hour9: 700, hour10: 700, hour11: 700, hour12: 700, hour13: 690, hour14: 680, hour15: 680, hour16: 690, hour17: 700, hour18: 700, hour19: 700, hour20: 700, hour21: 680, hour22: 650, hour23: 630 },
        { unitId: 'U007', status: 'running', hour0: 580, hour1: 560, hour2: 530, hour3: 500, hour4: 500, hour5: 530, hour6: 580, hour7: 620, hour8: 650, hour9: 670, hour10: 680, hour11: 690, hour12: 680, hour13: 670, hour14: 660, hour15: 660, hour16: 670, hour17: 680, hour18: 690, hour19: 690, hour20: 680, hour21: 660, hour22: 630, hour23: 600 },
        { unitId: 'U012', status: 'running', hour0: 980, hour1: 980, hour2: 980, hour3: 980, hour4: 980, hour5: 980, hour6: 980, hour7: 980, hour8: 980, hour9: 980, hour10: 980, hour11: 980, hour12: 980, hour13: 980, hour14: 980, hour15: 980, hour16: 980, hour17: 980, hour18: 980, hour19: 980, hour20: 980, hour21: 980, hour22: 980, hour23: 980 },
        { unitId: 'U013', status: 'running', hour0: 990, hour1: 990, hour2: 990, hour3: 990, hour4: 990, hour5: 990, hour6: 990, hour7: 990, hour8: 990, hour9: 990, hour10: 990, hour11: 990, hour12: 990, hour13: 990, hour14: 990, hour15: 990, hour16: 990, hour17: 990, hour18: 990, hour19: 990, hour20: 990, hour21: 990, hour22: 990, hour23: 990 },
        { unitId: 'U014', status: 'running', hour0: 975, hour1: 975, hour2: 975, hour3: 975, hour4: 975, hour5: 975, hour6: 975, hour7: 975, hour8: 975, hour9: 975, hour10: 975, hour11: 975, hour12: 975, hour13: 975, hour14: 975, hour15: 975, hour16: 975, hour17: 975, hour18: 975, hour19: 975, hour20: 975, hour21: 975, hour22: 975, hour23: 975 },
      ]
    }
  ],
...
export const mockInvoke = async (channel: string, ...args: any[]): Promise<any> => {
  await new Promise(r => setTimeout(r, 100));

  if (channel.startsWith('db:getAll')) {
    const table = args[0];
    if (table === 'topologyData') {
      return mockDB.topologyData[0];
    }
    return [...(mockDB[table] || [])];
  }

  if (channel.startsWith('db:getById')) {
    const [table, id] = args;
    return mockDB[table]?.find((item: any) => item.id === id) || null;
  }

  if (channel.startsWith('db:create')) {
  ...
  if (channel.startsWith('db:update')) {
    const [table, id, data] = args;
    const tableData = mockDB[table] || [];
  ...
  if (channel.startsWith('db:delete')) {
    const [table, id] = args;
    const tableData = mockDB[table] || [];
    const idx = tableData.findIndex((item: any) => item.id === id);
    if (idx !== -1) {
      return tableData.splice(idx, 1)[0];
    }
    return null;
  }

  if (channel.startsWith('plan:generate')) {
    const params = args[0] as GenerationParams;
    const units = mockDB.generatorUnits.filter((u: any) => u.status !== 'maintenance') as GeneratorUnit[];
    ...
    const plan = {
      ...
      totalLoadForecast: params.loadForecast.reduce((a: number, b: number) => a + b, 0) / 24,
    ...
    mockDB.generationPlans.push(plan);
    return plan;
  }

  if (channel.startsWith('plan:approve')) {
    const planId = args[0];
    const plan = mockDB.generationPlans.find((p: any) => p.id === planId);
    if (plan) {
  ...
  if (channel.startsWith('plan:confirm')) {
    const [planId, unitId] = args;
    const plan = mockDB.generationPlans.find((p: any) => p.id === planId);
    if (plan) {
  ...
  if (channel.startsWith('inspection:autoGenerate')) {
    const orders: any[] = [];
    const today = new Date().toISOString().split('T')[0];
    mockDB.transmissionLines.forEach((line: any) => {
      const riskScore = line.failureRate * 10 + (line.weatherRisk === 'high' ? 3 : line.weatherRisk === 'medium' ? 1 : 0);
      if (riskScore > 1.5) {
        const availableTeam = mockDB.inspectionTeams.find((t: any) => t.status === 'available');
        if (availableTeam) {
          const order = {
          ...
          mockDB.inspectionWorkOrders.push(order);
          orders.push(order);
        }
      }
    });
  ...
  if (channel.startsWith('fault:dispatchRepair')) {
    const params = args[0];
    const substation = mockDB.substations.find((s: any) => s.id === params.substationId);
    if (!substation) return null;
    let nearestTeam: any = null;
    let minDistance = Infinity;
    mockDB.repairTeams.forEach((team: any) => {
    ...
    mockDB.repairWorkOrders.push(order);
    nearestTeam.status = 'onMission';
    return order;
  }

  if (channel.startsWith('report:exportExcel')) {
    return `/tmp/电网运营报告_${args[0].month}.xlsx`;
  }

  if (channel.startsWith('rt:simulateTick')) {
    tickCount++;
    const events: any[] = [];

    mockDB.generatorUnits.forEach((unit: any) => {
    ...
    mockDB.busbars.forEach((bus: any) => {
      const baseFreq = 50;
      ...
      if (tickCount % 5 === 0 && (bus.voltage < bus.voltageLimit.min || bus.voltage > bus.voltageLimit.max)) {
        events.push({
    ...
    if (events.length > 0) {
      mockDB.alerts.unshift(...events);
      if (mockDB.alerts.length > 500) mockDB.alerts.length = 500;
    }
